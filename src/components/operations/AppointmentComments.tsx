...
export const AppointmentComments = ({ appointmentId }: AppointmentCommentsProps) => {
...
export const LastCommentPreview = ({ appointmentId }: { appointmentId: string }) => {
