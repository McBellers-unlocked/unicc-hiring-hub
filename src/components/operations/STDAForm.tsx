...
const stdaSchema = z.object({
  ...
  staff_number: z.string().optional().or(z.literal('')),
  ...
  duty_station: z.string().optional().or(z.literal('')),
  section_unit: z.string().optional().or(z.literal('')),
  supervisor: z.string().optional().or(z.literal('')),
  old_pd: z.string().optional().or(z.literal('')),
  new_pd: z.string().optional().or(z.literal('')),
  vacancy_reference: z.string().optional().or(z.literal('')),
  main_hr_focal_point: z.string().optional().or(z.literal('')),
  comments: z.string().optional().or(z.literal('')),
  actions_in_hr_plan: z.string().optional().or(z.literal('')),
  original_job_title: z.string().optional().or(z.literal('')),
  original_grade: z.string().optional().or(z.literal('')),
  original_unit: z.string().optional().or(z.literal('')),
});
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="P. Nieto" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
