...
const appointmentSchema = z.object({
  ...
  old_po: z.string().optional().or(z.literal('')),
  new_po: z.string().optional().or(z.literal('')),
  vacancy_reference: z.string().optional().or(z.literal('')),
  main_hr_focal_point: z.string().optional().or(z.literal('')),
  recruitment_type: z.string().optional().or(z.literal('')),
  is_international: z.boolean(),
  notice_days_required: z.number().min(0).max(365),
  comments: z.string().optional().or(z.literal('')),
  onboarding_comments: z.string().optional().or(z.literal('')),
